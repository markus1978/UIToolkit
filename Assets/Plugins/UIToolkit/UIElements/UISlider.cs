...
public class UISlider : UITouchableSprite
{
	...
	public static UISlider create( string knobFilename, string trackFilename, int trackxPos, int trackyPos, UISliderLayout layout){return create(knobFilename,trackFilename,trackxPos,trackyPos,layout,2);}
	public static UISlider create( string knobFilename, string trackFilename, int trackxPos, int trackyPos, UISliderLayout layout, int depth){return create(knobFilename,trackFilename,trackxPos,trackyPos,layout,depth,true);}
	...
	public static UISlider create( UIToolkit manager, string knobFilename, string trackFilename, int trackxPos, int trackyPos, UISliderLayout layout){return create (manager,knobFilename,trackFilename,trackxPos,trackyPos,layout,2);}
